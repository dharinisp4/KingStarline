...
//    public static final String BASE_URL="https://www.kingstarline.com/restApi/api.php?api=";
    public static final String BASE_URL="https://www.kingstarline.com/restApi/";
   ...
   public static final String URL_Forgot_UserId =BASE_URL+ "forgotusername.php";
   public static final String URL_REGIST=BASE_URL+"users.php";
    public static final String Url_Wallet=BASE_URL+"wallet_amount.php";
    ...
    public static final String Url_data_insert_sangum=BASE_URL+"SaveDataApis/sangum_data_insert.php";
    public static final String Url_data_insert_req=BASE_URL+"Request/request_points.php";
    public static final String Url_data_insert_with_req=BASE_URL+"Request/withdraw_request.php";
    public static final String Url_req_history=BASE_URL+"Request/request_history.php";
    public static final String Url_wthdraw_req_history=BASE_URL+"Request/withdraw_history.php";
    public static final String Url_req_notification=BASE_URL+"notification_data.php";
